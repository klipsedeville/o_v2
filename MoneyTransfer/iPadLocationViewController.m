...
#import "iPadLocationViewController.h"
#import "Constants.h"
#import "Controller.h"
#import "AppDelegate.h"
#import "iPadBillerViewController.h"

@interface iPadLocationViewController ()

@end

@implementation iPadLocationViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    _selectedCategoryValue = [[NSUserDefaults standardUserDefaults]valueForKey:@"selectCategoryID"];
...
-(void)GetStatesList
{
    ...
    NSString *selectCountryCode =  [[NSUserDefaults standardUserDefaults]valueForKey:@"selectCountryCode"];
    [Controller GetBillStatesListByCountryID:selectCountryCode withSuccess:^(id responseObject)
     {
         [HUD removeFromSuperview];
         ...
         if ( Status  == YES)
         {
             billsCategoryArray= [ payLoadDic valueForKeyPath:@"data.states"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *nameLbl = [[ UILabel alloc] initWithFrame:CGRectMake(30,10,SCREEN_WIDTH-140,40)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //        billInstructionDic = [billArray objectAtIndex:indexPath.row];
    selectedState = [NSString stringWithFormat:@"%@", [[billsCategoryArray objectAtIndex:indexPath.row]valueForKey:@"id"]];
    [ [NSUserDefaults standardUserDefaults]setValue:selectedState forKey:@"selectedState"];
    [[NSUserDefaults standardUserDefaults]synchronize];
//    [self performSegueWithIdentifier:@"billerSegue2" sender:self];
