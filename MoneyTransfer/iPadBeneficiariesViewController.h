//
//  iPadBeneficiariesViewController.h
//  MoneyTransfer
//
...
@interface iPadBeneficiariesViewController : UIViewController<UITableViewDataSource,UITableViewDelegate, UIGestureRecognizerDelegate>
{
