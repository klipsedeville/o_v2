...
@interface ipadAddCardViewController ()

@end

@implementation ipadAddCardViewController
...
- (void)viewDidLoad {
    ...
    [ [NSUserDefaults standardUserDefaults] setValue:nil forKey:@"NewCard"];
