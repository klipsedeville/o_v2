//
//  iPadTransferCompletedViewController.m
//  MoneyTransfer
//
...
#import "iPadTransferCompletedViewController.h"
#import "iPadLoginViewController.h"

@interface iPadTransferCompletedViewController ()

@end

@implementation iPadTransferCompletedViewController
#pragma mark ######
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSString *loginUserName = [userDataDict valueForKeyPath:@"first_name"];
    ...
    [_userNameLbl setFont:[UIFont boldSystemFontOfSize:30]];
    [_transactionIDLbl setFont:[UIFont boldSystemFontOfSize:28]];
}
