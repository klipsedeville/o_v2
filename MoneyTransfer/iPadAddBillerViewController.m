...
#import "iPadAddBillerViewController.h"
...
@interface iPadAddBillerViewController ()
{
    AppDelegate *appDel;
}
...
@implementation iPadAddBillerViewController
...
- (IBAction)currencyBtnClicked:(id)sender
{
    ...
    if (allCurrencyArray == NULL)
    {
        ...
        _currencyView.frame = CGRectMake(SCREEN_WIDTH/2-_currencyView.frame.size.width/2, -5, 90, 25);
...
{
    [_scrollView setContentSize:CGSizeMake( _scrollView.frame.size.width, _lastView.frame.origin.y+_lastView.frame.size.height+10)];
...
- (void)textFieldDidBeginEditing:(UITextField *)textField
{
    ...
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_firstNameTextfield.frame.origin.x, _nameView.frame.origin.y+50, _firstNameTextfield.frame.size.width, _firstNameTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    ...
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_lastNameTextfield.frame.origin.x, _nameView.frame.origin.y+50, _lastNameTextfield.frame.size.width, _lastNameTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _emailAddressTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_emailAddressTextfield.frame.origin.x, _emailView.frame.origin.y+50, _emailAddressTextfield.frame.size.width, _emailAddressTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _phoneNumberTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_phoneNumberTextfield.frame.origin.x, _numberView.frame.origin.y+50, _phoneNumberTextfield.frame.size.width, _phoneNumberTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _physicalAddressTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_physicalAddressTextfield.frame.origin.x, _addressView.frame.origin.y+50, _physicalAddressTextfield.frame.size.width, _physicalAddressTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _accountNameTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_accountNameTextfield.frame.origin.x, _accNameView.frame.origin.y+50, _accountNameTextfield.frame.size.width, _accountNameTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _accountNumberTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_accountNumberTextfield.frame.origin.x, _accountNumberView.frame.origin.y+50, _accountNumberTextfield.frame.size.width, _accountNumberTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _billNameTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_billNameTextfield.frame.origin.x, _billNameView.frame.origin.y+50, _billNameTextfield.frame.size.width, _billNameTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    else if (textField == _billAmountTextfield)
    {
        UIView *tempVW = [[ UIView alloc] init];
        tempVW.frame = CGRectMake(_billAmountTextfield.frame.origin.x, _lastView.frame.origin.y+50, _billAmountTextfield.frame.size.width, _billAmountTextfield.frame.size.height );
        [self scrollViewToCenterOfScreen:tempVW];
    }
    _scrollView.bounces = NO;
}
...
{
    [_scrollView setContentSize:CGSizeMake( _scrollView.frame.size.width, _scrollView.frame.size.height+680)];
    _scrollView.bounces = NO;
