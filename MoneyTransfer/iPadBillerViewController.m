...
#import "Controller.h"
#import "iPadBillViewController.h"

@interface iPadBillerViewController ()
{
    BOOL ViewPresented;
...
@implementation iPadBillerViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (ViewPresented)
    {
        ...
        UILabel *nameLbl = [[ UILabel alloc] initWithFrame:CGRectMake(30,10,200,40)];
